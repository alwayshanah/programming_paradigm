...
public class ChangingFace extends Application {
    ...
    public void start(Stage stage) {
        ...
        frownButton.setOnAction(e -> {mouth.setLength(180); caption.setText("Frowning Face");});
        // supply the code that is executed when the smile button is pressed
        smirkButton.setOnAction(e -> {mouth.setLength(-130); caption.setText("Smirking Face");});
        // add the scene to the stage, then set the title
        stage.setScene(scene);
        stage.setTitle("Changing Face by Hanah Castaneda");
        // show the stage
        stage.show();
    }
